...
// Modified from https://gist.github.com/pJotoro/1fe2c72e192b4712db484490b70197eb
...
create_debug_logger :: proc(lowest := log.Level.Debug, opt := log.Default_Console_Logger_Opts, ident := "") -> log.Logger {
...
destroy_debug_logger :: proc(logger: log.Logger) {
	free(logger.data)
}